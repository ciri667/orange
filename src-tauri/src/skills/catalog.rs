use crate::domain::{
    AgentSkill, SkillCompatibilityReport, SkillRuntimeManifest, SkillRuntimeStatus,
};
use crate::storage::{format_local_datetime, lock_database_writer};
...
pub(super) const SKILL_MARKDOWN_FILE_NAME: &str = "SKILL.md";
...
pub(super) const ORANGE_INSTALL_METADATA_FILE_NAME: &str = "orange.yaml";
...
pub(super) fn should_walk_skill_entry(entry: &walkdir::DirEntry) -> bool {
...
pub(super) fn load_custom_skill(
    root: &Path,
...
#[derive(Clone, Debug)]
pub(super) struct ParsedSkillMarkdown {
...
pub(super) fn parse_skill_markdown(content: &str) -> Result<ParsedSkillMarkdown, String> {
...
pub(super) fn safe_skill_folder_name(name: &str) -> Result<String, String> {
...
pub(super) fn should_skip_install_relative_path(relative_path: &Path) -> bool {
...
pub(super) fn hash_skill_directory(skill_dir: &Path) -> Result<String, String> {
...
pub(super) fn read_persisted_skills(
    connection: &Connection,
) -> Result<HashMap<String, AgentSkill>, String> {
...
pub(super) fn upsert_skill_state_override(
    connection: &Connection,
    skill: &AgentSkill,
) -> Result<(), String> {
...
#[cfg(test)]
mod tests {
    use super::super::install::{INSTALL_CONFLICT_FAIL, INSTALL_CONFLICT_REPLACE};
    use super::*;
    use crate::skills::*;
    use std::io::Write;
